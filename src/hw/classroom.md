...
6.  Вернитесь в GitHub. 

    > Мы теперь используем свой облачный сервер для actions[^1], поэтому теперь actions можно не экономить, и их можно не запускать вручную: они запускаются автоматически при каждом commit-е. При этом в истории коммитов рядом с каждым появляется галочка или крестик.

    Если тесты не проходят, можно увидеть более подробный отчет, 
    нажав на галочку или крестик рядом с этим коммитом в истории коммитов.
